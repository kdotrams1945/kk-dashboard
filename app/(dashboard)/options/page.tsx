...
//     };
//     //  http://localhost:8080/optionResult?loan=200000&yearlyInterestRate=0.0725&years=30
//     //http://localhost:8080/option-analysis?stockPrice=200&yearlyInterestRate=0.045&sigma=0.3&type=Call&daysUntilExpiry=300&strikePrice=230&contracts=-1
//     //curl -X 'GET' \
  
//     console.log(data);
//     const urlParams = new URLSearchParams(data);
//     // const url = `http://localhost:8080/option-analysis?${urlParams}`;
//     // const url2 = `http://localhost:8080/option-analysis1?${urlParams}`;
